     ...
     @Override
      ...
      public void messageReceived(IoSession session, Object message)
		  ...
		  try{
			  ...
			  /**
			   * Los tenemos que crear, ya que se pasan argumentos
	 	    	  ...
	 	    	  if(data==13){
	    			  ...
	    			  try{
	    				  ...
	    				  if(myMsgSequence==tmpSequence){
	    					   ...
	    					   */
	    					  messageProcessing.receiv(strbuf.toString().substring(sizestrbuf-MSG_LENGTH, sizestrbuf));
	    			  ...
	    			  strbuf.delete(0, strbuf.length());//Que es mas caro borrar o leer el objeto
	 	    	  }
	 	    	  data = br.read();
	 	      }
